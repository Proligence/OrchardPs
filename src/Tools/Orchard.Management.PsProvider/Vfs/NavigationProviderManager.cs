...
namespace Orchard.Management.PsProvider.Vfs 
{
    ...
    public class NavigationProviderManager : INavigationProviderManager 
    {
        ...
        /// <summary>
        /// The dependency injection container for the Orchard drive which the manager belongs to.
        /// </summary>
        ...
        {
            IEnumerable<IPsNavigationProvider> providers = this.GetProviders();
            providers.OrderBy(np => np.GetPathLength());
