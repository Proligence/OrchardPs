// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnableOrchardFeature.cs" company="Proligence">
...
namespace Proligence.PowerShell.Modules.Cmdlets
{
    ...
    public class EnableOrchardFeature : OrchardCmdlet
    {
        ...
        protected override void ProcessRecord()
        {
            ...
            if (feature != null)
            {
                if (this.ShouldProcess("Feature: " + feature.Id + ", Site: " + siteName, "Enable Feature"))
                {
                    this.modulesAgent.EnableFeature(siteName, feature.Id, !this.WithoutDependencies.ToBool());
                }
            }
        }
