...
namespace Proligence.PowerShell.Web {
    ...
    public class ResourceManifest : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineScript("jQuery_Console")
                .SetUrl("jquery.console.js")
                .SetDependencies("jQuery", "jQueryUI_Progressbar");
            manifest.DefineScript("PS_Console")
                .SetUrl("console.js")
                .SetDependencies("jQuery_SignalR", "jQuery_Console", "PS_Knockout");
        }
    }
}